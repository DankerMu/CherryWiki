export enum ErrorCode {
  ...
  SESSION_SPACE_SCOPE_MISMATCH = 'SESSION_SPACE_SCOPE_MISMATCH',
  ...
  NO_EMBEDDING_MODEL_CONFIGURED = 'NO_EMBEDDING_MODEL_CONFIGURED',
